...
namespace ClrMDExt
{
    // Taken from https://github.com/Microsoft/clrmd/blob/master/src/Samples/WindbgExtension/Common.cs
    //
    //
    ...
    class DbgEngStream : Stream
    {
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            m_control.ControlledOutput(DEBUG_OUTCTL.ALL_CLIENTS | DEBUG_OUTCTL.DML, DEBUG_OUTPUT.NORMAL, str);
        }
    }
